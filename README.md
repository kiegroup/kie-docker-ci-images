...
* For each project's sub-module (`KIE Workbench`, `KIE Drools Workbench`, `KIE Execution Server`)               
    ...
    * Create Docker images for `KIE Workbench`, `KIE Drools Workbench`, and `KIE Execution Server` using specified versions.                                  
    * Push the images into the Docker registry (this step is currently disabled)                                    
    * Run a Docker container the each recently created image                    

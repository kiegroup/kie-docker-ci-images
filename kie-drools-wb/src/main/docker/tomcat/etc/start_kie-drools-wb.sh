...
./update-jpa-config.sh $CATALINA_HOME/webapps/kie-drools-wb/WEB-INF/classes/META-INF/persistence.xml
...
then
    echo "Using MySQL driver for kie-drools-wb datasource connection. "
...
then
    echo "Using PostgreSQL driver for kie-drools-wb datasource connection. "
